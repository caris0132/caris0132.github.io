...
function update () {
	...
	for (var i = monstersls.monsters.length - 1; i >= 0; i--) {
		...
		if(monstersls.monsters[i].cx < 0 || monstersls.monsters[i].cx > canvas.width)
			monstersls.monsters[i].speedX = -monstersls.monsters[i].speedX;
		if (monstersls.monsters[i].cy < 0 || monstersls.monsters[i].cy > canvas.height) 
			monstersls.monsters[i].speedY = -monstersls.monsters[i].speedY;
